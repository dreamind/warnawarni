 ...
 *
 * Adapted from: wrapper of color schemes from http://colorbrewer2.org for djeo
 * https://github.com/vvoovv/djeo-colorbrewer
 *
 */

Ext.define("Aura.visual.BrewerPalette", {
  singleton: true,
  uniquePaletteType: {
    "5": {
      "Five": {
        "colors": ["#ACACAC", "#A90D22", "#e2976a", "#8CB6D9", "#2958A5"]
      }
    },
    "3": {
      "Three": {
        "colors": ["#ACACAC", "#A90D22", "#2958A5"]
      }
    }
  },
  qualitative: {
  ...
  diverging: {
    ...
    "5": {
      "GreyRedBlue": {
        "colors": ["#7f7f7f", "#ca0020", "#f4a582", "#92c5de", "#0571b0"],
        "critVal": 3.0
      },
      "Spectral": {
    ...
    "7": {
      ...
      "RdGy": {
        "colors": ["#b2182b", "#ef8a62", "#fddbc7", "#ffffff", "#e0e0e0", "#999999", "#4d4d4d"],
        "critVal": 4.0
      },
      "RdYlBu": {
      ...
      "PuOr": {
        "colors": ["#b35806", "#f1a340", "#fee0b6", "#f7f7f7", "#d8daeb", "#998ec3", "#542788"],
        "critVal": 4.0
      },
      "BrBG": {
    ...
    "10": {
      ...
      "RdYlGn": {
        "colors": ["#a50026", "#d73027", "#f46d43", "#fdae61", "#fee08b", "#d9ef8b", "#a6d96a", "#66bd63", "#1a9850",
                   "#006837"
        ],
        "critVal": 5.5
      },
      "PRGn": {
        "colors": ["#40004b", "#762a83", "#9970ab", "#c2a5cf", "#e7d4e8", "#d9f0d3", "#a6dba0", "#5aae61", "#1b7837",
                   "#00441b"
        ],
        "critVal": 5.5
      },
      "RdBu": {
        "colors": ["#67001f", "#b2182b", "#d6604d", "#f4a582", "#fddbc7", "#d1e5f0", "#92c5de", "#4393c3", "#2166ac",
                   "#053061"
        ],
        "critVal": 5.5
      },
      "RdGy": {
        "colors": ["#67001f", "#b2182b", "#d6604d", "#f4a582", "#fddbc7", "#e0e0e0", "#bababa", "#878787", "#4d4d4d",
                   "#1a1a1a"
        ],
        "critVal": 5.5
      },
    ...
    "11": {
      "Spectral": {
        "colors": ["#9e0142", "#d53e4f", "#f46d43", "#fdae61", "#fee08b", "#ffffbf", "#e6f598", "#abdda4", "#66c2a5",
                   "#3288bd", "#5e4fa2"
        ],
        "critVal": 6.0
      },
      "RdYlGn": {
        "colors": ["#a50026", "#d73027", "#f46d43", "#fdae61", "#fee08b", "#ffffbf", "#d9ef8b", "#a6d96a", "#66bd63",
                   "#1a9850", "#006837"
        ],
        "critVal": 6.0
      },
      "PRGn": {
        "colors": ["#40004b", "#762a83", "#9970ab", "#c2a5cf", "#e7d4e8", "#f7f7f7", "#d9f0d3", "#a6dba0", "#5aae61",
                   "#1b7837", "#00441b"
        ],
        "critVal": 6.0
      },
      ...
      "RdGy": {
        "colors": ["#67001f", "#b2182b", "#d6604d", "#f4a582", "#fddbc7", "#ffffff", "#e0e0e0", "#bababa", "#878787",
                   "#4d4d4d", "#1a1a1a"
        ],
        "critVal": 6.0
      },
      ...
      "PuOr": {
        "colors": ["#7f3b08", "#b35806", "#e08214", "#fdb863", "#fee0b6", "#f7f7f7", "#d8daeb", "#b2abd2", "#8073ac",
                   "#542788", "#2d004b"
        ],
        "critVal": 6.0
      },
      "BrBG": {
        "colors": ["#543005", "#8c510a", "#bf812d", "#dfc27d", "#f6e8c3", "#f5f5f5", "#c7eae5", "#80cdc1", "#35978f",
                   "#01665e", "#003c30"
        ],
        "critVal": 6.0
      }
  ...
  sequential: {
    ...
    "6": {
      ...
      "PuBuGn": {
        "colors": ["#f6eff7", "#d0d1e6", "#a6bddb", "#67a9cf", "#1c9099", "#016c59"]
      },
      "YlGn": {
